...
<head>
    ...
    <link rel="stylesheet" href="css/edit_labs.css">
...
<body>
    ...
    <main>
            ...
            <div class="container-fluid  p-0 flex-column align-items-start">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav flex-column gap-1 p-0 me-3 mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../add_clinic/index.php">
        ...
        <div class="container-fluid pt-3 pe-5 ps-5">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 labs">
    ...
    <script src="addLabs.js"></script>
    <!-- <script src="deleteLabs.js"></script> -->
